...
public class BallsScene extends Scene{
    ...
    public BallsScene() {
        ...
        boundableObjects.add(new MovingSphere(new Point(-1, 1, 0), new Point(1, 1, 0), 1, 2,5, new Lambertian(Colors.RED)));
        ...
        world.add(new BVHNode(boundableObjects));

//        world.addAll(boundableObjects);
